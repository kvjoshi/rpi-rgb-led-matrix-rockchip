...
#define RK3399_PERI_BASE         0xFF000000
#define RK3566_PERI_BASE         0xFF000000
...
#define RK_GPIO_REGISTER_OFFSET         0x200000
#define RK_COUNTER_1Mhz_REGISTER_OFFSET   0x3000

#define RK_GPIO_PWM_BASE_OFFSET	(GPIO_REGISTER_OFFSET + 0xC000)
#define RK_GPIO_CLK_BASE_OFFSET	0x101000

#define RK_REGISTER_BLOCK_SIZE (4*1024)

#define RK_PWM_CTL      (0x00 / 4)
#define RK_PWM_STA      (0x04 / 4)
#define RK_PWM_RNG1     (0x10 / 4)
#define RK_PWM_FIFO     (0x18 / 4)
